...
public class NumberedBorder extends AbstractBorder {
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
		...
		for (int i = 0; i < visibleLines; ++i) {
			...
			py = lineHeight * i + 14;
			/*
			 * a linha de baixo define a distancia que o número fica da linha que separa a
			 * borda, o valor padrão era 2 foi ajustdo para 8
			 */
			px = lineLeft - (characterWidth * lenght) - 8;
